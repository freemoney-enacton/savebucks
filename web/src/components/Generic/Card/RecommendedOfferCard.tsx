...
const RecommendedOfferCard = ({ data }) => {
    ...
    <>
      ...
      >
        <div className="h-full flex flex-col rounded-lg overflow-hidden">
          <div className="shrink-0 relative h-[127px] w-full p-3 flex items-center justify-center bg-offer-card-banner-gr rounded-t-lg overflow-hidden">
            {/* <div className="absolute inset-0 z-0"> */}
            <Image
              loading="lazy"
              className="object-cover scale-110 blur-md"
              src={data?.image || '/images/offer-1.png'}
              fill
            ...
            />
            {/* </div> */}
            <div className="relative h-full aspect-square flex-shrink-0 rounded-lg overflow-hidden flex items-center justify-center">
              <Image
                loading="lazy"
      ...
      <OfferModal isOpen={isOpen} onOpenChange={onOpenChange} data={data} OfferModalData={OfferModalData} loading={false} />
