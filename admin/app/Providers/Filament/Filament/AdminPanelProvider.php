...
class AdminPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        ...
        return $panel
            ...
            ->navigationGroups([
                NavigationGroup::make()->label('Task & Survey Management'),
                NavigationGroup::make()->label('CMS'),
                NavigationGroup::make()->label('Manage Users'),
                NavigationGroup::make()->label('Rewards Settings'),
                NavigationGroup::make()->label('Settings'),
                NavigationGroup::make()->label('Reports & Logs'),
                NavigationGroup::make()->label('Leaderboards'),
                NavigationGroup::make()->label('Super Admin Control'),
            ])
            ->renderHook(
            ...
            ->plugins([
                ...
                SpatieLaravelTranslatablePlugin::make()
                    ->defaultLocales(config('freemoney.languages.keys') ?? ['en']),
            ])
            ->authMiddleware([
                Authenticate::class,
            ])
